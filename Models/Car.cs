...
class Car //Car class with 3 properties
{
  ...
  public void SetPrice(int newPrice) //'sets' as public so we can access outside of Car class. use void as the return type since SetPrice() will be setting a value, not returning anything
  {
...
//access modifyer: public
  ...
  public bool WorthBuying(int maxPrice)//define a WorthBuying method in the Car class. can only be called on Car objects bc defined in the Car class. WorthBuying takes one argument: maxPrice, and this argument is an int.
  {
